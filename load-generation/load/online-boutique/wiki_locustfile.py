...
# defines user behaivor patterns, i.e., frequency of each type of request
...
class StagesShapeWithCustomUsers(LoadTestShape):
    ...
    #wave_df = pd.read_csv('load/online-boutique/workloads/constant.csv')
    wave_list = wave_df['count'].tolist()
    scale_factor = 1
    # runs for 70 minutes
    time_limit, window_num = 70 * 60, 70
