...
files = {
    ...
    #"DAS": ["das_stats.csv"],
    "dadqn": ["dadqn_stats.csv"],
    "Custom-DAS": ["custom_das_stats.csv"],
}

files = {
    "HPA-80": ["hpa80_stats-1.csv", "hpa80_stats-2.csv"],
    "DAS": ["das_stats-1.csv", "das_stats-2.csv"],
    "Custom-DAS": ["custom_das_stats-1.csv", "custom_das_stats-2.csv"],
}
