...
INPUT_FILES = {
    ...
    "hpa60-CDT120": [
        Path("hpa60-CDT120-1_stats_history.csv"),
        Path("hpa60-CDT120-2_stats_history.csv"),
        Path("hpa60-CDT120-3_stats_history.csv"),
        Path("hpa60-CDT120-4_stats_history.csv"),
        Path("hpa60-CDT120-5_stats_history.csv"),
    ],

    "hpa60-CDT300": [
        Path("hpa60-CDT300-1_stats_history.csv"),
        Path("hpa60-CDT300-2_stats_history.csv"),
        Path("hpa60-CDT300-3_stats_history.csv"),
        Path("hpa60-CDT300-4_stats_history.csv"),
        Path("hpa60-CDT300-5_stats_history.csv"),
    ],
...
def main() -> None:
    ...
    # --------------------------------------------------------
    # Restrict every run to the shortest common runtime
    # --------------------------------------------------------
    ...
    common_final_minute = min(
        int(final_minutes.min()),
        MAX_MINUTE,
    )

    print(
        f"Shortest run ends at minute {common_final_minute}; "
        "truncating all runs to this common duration."
    )

    run_df = (
        run_df.loc[
            run_df["Minute"] <= common_final_minute
        ]
        .copy()
    )
