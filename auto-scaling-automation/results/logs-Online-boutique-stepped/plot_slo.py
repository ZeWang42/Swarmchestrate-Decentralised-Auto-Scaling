...
INPUT_FILES = {
    "queue": [
        Path("queue-1_stats.csv"),
        Path("queue-2_stats.csv"),
        Path("queue-3_stats.csv"),
    ],
    "hpa80": [
        Path("hpa80-1_stats.csv"),
        Path("hpa80-2_stats.csv"),
        Path("hpa80-3_stats.csv"),
    ],
    "das": [
        Path("das-1_stats.csv"),
        Path("das-2_stats.csv"),
        Path("das-3_stats.csv"),
    ],
}
