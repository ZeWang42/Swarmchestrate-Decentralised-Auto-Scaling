...
INPUT_FILES = {
    "queue-CDT120": [
        Path("queue-CDT120-1_stats.csv"),
        Path("queue-CDT120-2_stats.csv"),
        Path("queue-CDT120-3_stats.csv"),
        Path("queue-CDT120-4_stats.csv"),
        Path("queue-CDT120-5_stats.csv"),
    ],
    
    "queue-CDT300": [
        Path("queue-CDT300-1_stats.csv"),
        Path("queue-CDT300-2_stats.csv"),
        Path("queue-CDT300-3_stats.csv"),
        Path("queue-CDT300-4_stats.csv"),
        Path("queue-CDT300-5_stats.csv"),
    ],
    "hpa60-CDT120": [
        Path("hpa60-CDT120-1_stats.csv"),
        Path("hpa80-CDT120-2_stats.csv"),
        Path("hpa80-CDT120-3_stats.csv"),
        Path("hpa80-CDT120-4_stats.csv"),
        Path("hpa80-CDT120-5_stats.csv"),
    ],
        
    "hpa80-CDT300": [
        Path("hpa80-CDT300-1_stats.csv"),
        Path("hpa80-CDT300-2_stats.csv"),
        Path("hpa80-CDT300-3_stats.csv"),
        Path("hpa80-CDT300-4_stats.csv"),
        Path("hpa80-CDT300-5_stats.csv"),
    ],
...
def get_aggregated_row(
    ...
    """
    Return Locust's Aggregated row.

    Falls back to the final row if Aggregated is missing.
    """
