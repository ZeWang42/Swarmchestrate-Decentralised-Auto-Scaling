...
from config import DEFAULT_NAMESPACE, MONITOR_LOG_DIR
...
#                     writer.writerow([ts, "service", svc, round1(http_rpm), round1(http_lat), round1(grpc_rpm), round1(grpc_lat), cpu_m, mem_mib, pods, "", "", "", ""])
#                     f.flush()
...
#                     writer.writerow([ts, "node", node, "", "", "", "", cpu_m, mem_mib, "", round1(cpu_pct), round1(mem_pct), round1(net_rx_bps), round1(net_tx_bps)])
#                     f.flush()
#             except Exception as exc:
